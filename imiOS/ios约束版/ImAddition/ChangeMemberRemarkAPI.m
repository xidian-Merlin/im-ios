...
@implementation ChangeMemberRemarkAPI
/**
 *  请求超时时间
 *
 *  @return 超时时间
...
{
    return IM_GRP_CHANGE_MEM_REMARK;
}
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t packageID)
    {
        ...
        [dataout writeTcpProtocolHeaderWithCommandID:IM_GROUP subcommandID:IM_GRP_CHANGE_MEM_REMARK packageID:packageID];
