...
//  ImAddition
//
//  Created by yuhui wang on 16/8/10.
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t packageID)
    {
        ...
        [dataout writeTcpProtocolHeaderWithCommandID:IM_MESSAGE subcommandID:IM_MESS_TEXT packageID:packageID];
