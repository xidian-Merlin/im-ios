...
//  ImAddition
//
//  Created by yuhui wang on 16/8/21.
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t packageID)
    {
        ...
        NSString *vadioPath = object[2];
        NSData *vadioData = [NSData dataWithContentsOfFile:vadioPath];
        
        DataOutputStream *dataout = [[DataOutputStream alloc] init];
        [dataout writeTcpProtocolHeaderWithCommandID:IM_MESSAGE subcommandID:IM_MESS_VADIO packageID:packageID];
