...
@implementation KickFromGroupAPI
/**
 *  请求超时时间
 *
 *  @return 超时时间
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t packageID)
    {
        ...
        [dataout writeTcpProtocolHeaderWithCommandID:IM_GROUP subcommandID:IM_GRP_KICK packageID:packageID];
