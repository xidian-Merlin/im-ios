...
- (Package)packageRequestObject
{
    ...
    {
        NSString *nick = object;
        DataOutputStream *dataout = [[DataOutputStream alloc] init];
        [dataout writeTcpProtocolHeaderWithCommandID:IM_SETTING subcommandID:IM_SET_NICKNAME packageID:packageID];
