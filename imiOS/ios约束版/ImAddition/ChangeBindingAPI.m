...
//  ios约束版
//
//  Created by tongho on 2016/12/2.
...
@implementation ChangeBindingAPI
/**
 *  请求超时时间
 *
 *  @return 超时时间
...
- (Package)packageRequestObject
{
    ...
    {
        NSString *phone = object[0];
        NSString *mail = object[1];
        int verification = [object[2] intValue];
        
        DataOutputStream *dataout = [[DataOutputStream alloc] init];
        [dataout writeTcpProtocolHeaderWithCommandID:IM_SETTING subcommandID:IM_SET_CHANGEBIND packageID:packageID];
        
        [dataout directWriteUTF:phone];
        [dataout writeUTF:mail];
        [dataout writeInt:verification];
