...
@implementation ChangeGroupNameAPI
/**
 *  请求超时时间
 *
 *  @return 超时时间
...
- (Package)packageRequestObject
{
    Package package = (id)^(id object,uint32_t packageID)
    {
        ...
        NSString* name = object[2];
        
        DataOutputStream *dataout = [[DataOutputStream alloc] init];
        [dataout writeTcpProtocolHeaderWithCommandID:IM_GROUP subcommandID:IM_GRP_CHANGE_NAME packageID:packageID];
