...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _canvasView = [[UIImageView alloc] initWithFrame:CGRectMake(10, 5, 50, 50)];
        // canvasView.layer.cornerRadius = 10;
       // _canvasView.layer.masksToBounds = YES;
        _canvasView.backgroundColor = [UIColor colorWithWhite:0.839 alpha:1.000];
        _hub = [[RKNotificationHub alloc]initWithView:_canvasView];
...
- (void)createIconWihgroupId:(int)groupId {
 ...
 //   canvasView.layer.masksToBounds = YES;
  //  canvasView.backgroundColor = [UIColor colorWithWhite:0.839 alpha:1.000];
    ...
    UIImageView *coverImage = [[StitchingImage alloc] stitchingOnImageView:_canvasView withImageViews:imageViews];
